...
if (isAdminLoggedIn()) {
    ...
    logSecurityEvent("Admin logout", "User: $username, IP: $ip");
}
...
<head>
    ...
    <title>Confirm Logout - Crestfield Admin</title>
...
<body>
    <div class="logout-card">
        ...
        <div class="button-group">
            ...
            <a href="<?= BASE_URL ?>/admin/dashboard.php" class="btn btn-cancel">Cancel</a>
        </div>
