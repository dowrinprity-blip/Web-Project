...
<div class="register-wrap">
    ...
    <div style="text-align:center;padding:3rem 0;">
        ...
        <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap;">
            <a href="programme_detail.php?id=<?= $programme['ProgrammeID'] ?>" class="btn btn-navy">View Programme →</a>
            <a href="programmes.php" class="btn" style="background:var(--cream);color:var(--navy);border:1px solid var(--border);">Browse More</a>
            <?php if(isStudentLoggedIn()): ?>
            <a href="<?= BASE_URL ?>/student/my_interests.php" class="btn btn-gold">View My Interests →</a>
            <?php else: ?>
            <a href="<?= BASE_URL ?>/student/register.php" class="btn btn-navy">Create Account to Track Interests →</a>
            <?php endif; ?>
        </div>
    </div>
