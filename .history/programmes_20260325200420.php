...
// Fetch programmes with image and leader
        ...
        <div class="cards-grid">
            ...
            <a href="programme_detail.php?id=<?= $prog['ProgrammeID'] ?>" class="card">
                ...
                <div class="card-image">
                    <img src="<?= htmlspecialchars($prog['Image']) ?>" alt="<?= htmlspecialchars($prog['ProgrammeName']) ?>" style="width:100%;height:200px;object-fit:cover;">
                </div>
                <?php endif; ?>
                <div class="card-body">
